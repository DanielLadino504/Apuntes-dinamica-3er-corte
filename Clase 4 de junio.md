...
- $$\Delta$$ = 1 - (suma ganancias de los lazos) + (suma producto de 2 lazos que no se tocan $$P_{k}$$) - (suma producto de 3 lazos que no se tocan) + .................
- $$\Delta _{k}$$ = 1 -(suma ganancia 3 lazos que no toquen la trayectoria $$P_{k}$$ y no se toquen entre si - (suma ganancia 2 lazos que no toquen la trayectoria $$P_{k}$$ y no se toquen entre si ) - (suma ganancia 3 lazos que no toquen la trayectoria $$P_{k}$$ y no se toquen entre si) + .......................
